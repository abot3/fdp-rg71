...
# significance was determined based on review of the model summary's coefficient
# p-values
...
Starting with the base model, a $R^2$ of 0.7528 is among the lowest that we found
...
In doing so, we found some imrpovements to the $R^2$ and RMSE. In fact, they wound
...
plot_fitted_resid(mid_atlantic_base_model)
plot_fitted_resid(mid_atlantic_full_model)
plot_fitted_resid(improved_mid_atlantic_int_model)
plot_fitted_resid(log_mid_atlantic_int_model)
```
...
plot_qq(mid_atlantic_base_model)
plot_qq(mid_atlantic_full_model)
plot_qq(improved_mid_atlantic_int_model)
plot_qq(log_mid_atlantic_int_model)
```
